...
class _ProfileClient implements ProfileClient {
  ...
  Future<ProfileData> getProfile() async {
    ...
    late ProfileData _value;
    try {
      _value = ProfileData.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<ProfileData> updateProfile(Map<String, dynamic> request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
  ...
  Future<PersonalizationData> getPersonalization() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PersonalizationData _value;
    try {
      _value = PersonalizationData.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
